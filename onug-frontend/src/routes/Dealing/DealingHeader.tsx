...
import { StyledGameTableHeader, PlayerInfo, PlayerName, PlayerCardInfo, PlayerCardRule } from './Dealing.styles'
import { GameTableHeaderProp } from './Dealing.types'
import { ROLES } from 'constant'

export const DealingHeader: React.FC<GameTableHeaderProp> = observer(
  ({ player }) => {
