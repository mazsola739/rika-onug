...
export const order: OrderJson[] = [
  ...
  },
  {
    ...
    card_id: [47, 54, 1],
    scene_number: 28,
    condition: selectedCards => selectedCards.some(card => card.id === 47) && selectedCards.some(card => card.id === 54)
  },
  {
    scene_title: 'LEADER',
    card_id: [48, 1],
  ...
  },
  {
    ...
    scene_number: 45,
    condition: selectedCards =>
      (selectedCards.some(card => card.id === 5) && selectedCards.some(card => card.id === 6)) ||
      ((selectedCards.some(card => card.id === 5) || selectedCards.some(card => card.id === 6)) && selectedCards.some(card => card.id === 1))
  },
  {
    scene_title: 'THING',
    card_id: [85],
