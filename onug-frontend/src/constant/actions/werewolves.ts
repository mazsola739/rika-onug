export const werewolves = {
  ...
  dreamwolf_close_text: 'Dreamwolf, put your thumb away.',
  werewolves_lonewolf_text:
    'If there is only one werewolf, you may look at a card from the center.',
  werewolves_close_text: 'WEREWOLVES, close your eyes.',
}
