...
export const random_oracle = {
  ...
  random_oracle_center: {
    ...
    answer_yes: {
      oracle_view1_text: 'Three is way too many, you may look at one of them.',
      oracle_view2_text: 'Three is one too many, you may look at two of them.',
      oracle_view3_text:
        "That's crazy! But go ahead, and look at all three of them.",
    },

    answer_no: { oracle_ripple_no_text: 'Seriously? Why not? Okay, whatever.' },
  },
