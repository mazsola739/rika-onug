...
export const interaction_apprenticeseer = '' //? INFO: Apprentice Seer - looks at one card from the center (not another players or her own)
...
export const interaction_thing = '' //? INFO: Thing - Taps the nearest shoulder of the player on their immediate right or left
