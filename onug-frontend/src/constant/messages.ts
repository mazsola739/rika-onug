...
export const interaction_blob = '' //? INFO: Blob -  Wins if no player part of him (left, right or both), via app, dies
export const interaction_copycat = '' //? INFO: Copycat - Looks at one card from the center and becomes that card. Does the action when called
export const interaction_cow = '' //? INFO: Cow - Puts hand out in a fist when Aliens wake. If an Alien is sitting next to her, one must tap her fist
...
export const interaction_exposer = '' //? INFO: Exposer - May flip 0-3 center cards over, the max via app
...
export const interaction_priest = '' //? INFO: Priest - Swaps his mark and one other player's mark with a Mark of Clarity. which purge other Marks)
export const interaction_psychic = '' //? INFO: Psychic - Looks at 1-2 cards, which in position via app such as neighbors, center, odd or even players
export const interaction_rascal = '' //? INFO: Rascal - May manipulate cards via app such as stealing, switching, moving, etc
export const interaction_renfield = '' //? INFO: Renfield - With their eyes closed, sees who Vampires gave Mark of the Vampire; then gives himself Mark of the Bat
export const interaction_revealer = '' //? INFO: Revealer - Turns and keeps one player's card face up unless they are not on the Villager Team
...
export const interaction_thing = '' //? INFO: Thing - Taps the nearest shoulder of the player on their immediate right or left //THING, ANNOYING_LAD
