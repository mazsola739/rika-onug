...
//any specific player
export const action_werewolves = 'MessageBoxLook for Werewolves'
...
export const action_vampires = 'MessageBoxLook for Vampires'
export const action_no_vampires = 'No Vampires'
export const action_aliens = 'MessageBoxLook for Aliens'
export const action_no_aliens = 'No Aliens'
export const action_zerbgroob = 'MessageBoxLook for Zerb and Groob'
export const action_zerb = 'MessageBoxLook for Zerb'
export const action_no_zerb = 'No Zerb player'
export const action_groob = 'MessageBoxLook for Groob'
export const action_no_groob = 'No Groob player'
export const action_no_zerbgroob = 'No Zerb player nor Groob player, sorry'
export const action_groobzerb = 'MessageBoxLook for Groob and Zerb'
export const action_villains = 'MessageBoxLook for Super Villains'
export const action_no_villains = 'No Super Villains'
export const action_tanner = 'MessageBoxLook for Tanner'
export const action_no_tanner = 'No Tanner player'
export const action_assassin = 'MessageBoxLook for Assassin'
export const action_no_assassin = 'No Assassin player'
export const action_apprenticeassassin = 'MessageBoxLook for Apprentice Assassin'
export const action_no_apprenticeassassin = 'No Apprentice Assassin player'
export const action_mad = 'MessageBoxLook for Mad Scientist'
export const action_no_mad = 'No Mad Scientist player'
export const action_masons = 'MessageBoxLook for Masons'
export const action_no_masons = 'No Mason player'
export const action_seers = 'MessageBoxLook for Seer(s)'
export const action_card_or_mark_action = 'MessageBoxLook for other players who have performed a card or mark action'
export const action_mark_of_lover = 'MessageBoxLook for your love interest'
export const action_no_mark_of_lover = 'None loves you'
export const action_part_of_blob = 'MessageBoxLook for part of blob'
export const action_part_of_family = 'MessageBoxLook for part of family'
export const action_own_card = 'MessageBoxLook for your own card'
export const action_own_mark = 'MessageBoxLook for your own mark'
export const action_selected_card = 'MessageBoxLook for selected card'
