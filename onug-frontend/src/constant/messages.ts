...
export const interaction_aliens =
  'Aliens - View their fellow Aliens (including Body Snatcher, Synthetic, Groob and Zerb) and do the action app says'
export const interaction_apprenticeassassin =
...
export const interaction_vampire =
...
export const interaction_witch =
