...
const random_ripple_1minute: Record<string, string> = {
  ripple_1minute_text: 'You will only have one minute before you have to vote.',
}

const random_ripple_repeat: Record<string, string> = {
  ripple_repeat_text:
...
const random_ripple_repeat1p: Record<string, string> = {
...
const random_ripple_troublemaker: Record<string, string> = {
...
const random_ripple_steal: Record<string, string> = {
...
const random_ripple_dualview: Record<string, string> = {
  //2p  center any even any odd any player
  ripple_dualseer_text: 'together, you may view one card from',
  ripple_view2_text: 'You may view two cards from',
}

const random_ripple_twovote: Record<string, string> = {
...
const random_ripple_shuffle: Record<string, string> = {
  //1p
...
const random_ripple_iamalien: Record<string, string> = {
...
const random_ripple_none: Record<string, string> = {}
