export const QG = {
  'Annoying Lad': 'looks at one card from the center (not another players or her own)',
  'Apprentice Seer': 'All players that have viewed or moved a card or mark stick up their thumbs for her to see (list of roles in FAQ)',
  ...
  'Paranormal Investigator':
    "Looks at two other player's cards one at a time; if he sees team they are not on the Villager Team he stops looking and becomes that role. May not look at any center cards.",
  ...
  Seer: "Looks at one player's card (not her own) or two cards from the center",
  ...
  'Shroud of Shame':
    " the player's role is unaffected, but they must turn away from the other players for the duration of the game and not see any player's cards or tokens, or ever turn back around to vote",
