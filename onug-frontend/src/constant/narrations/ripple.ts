...
export const random_ripple_repeat = {
  ripple_repeat_text:
...
export const random_ripple_repeat1p = {
  ripple_repeat_text:
    "You've entered a time loop and must repeat the entire night.",
  ripple_repeat_2_text: 'Some roles may not wake up during the time loop.',
...
export const random_ripple_iamalien = {
