...
export const rascal_robberend_text = 'giving your card to that player. View your new card - you are now that role, but you will do any action if that role is called later in the night.'
