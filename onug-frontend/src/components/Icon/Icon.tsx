...
export const Icons: Record<IconType, React.FC<React.SVGProps<SVGSVGElement>>> = { closed: ClosedIcon, closing: ClosingIcon, connecting: ConnectingIcon, open: OpenIcon, uninstantiated: UninstantiatedIcon }
