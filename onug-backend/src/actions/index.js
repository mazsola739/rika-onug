...
const { doppelganger } = require("./doppelganger")

/*  D U S K */
const { vampires } = require("./vampires")
const { thecount } = require("./thecount")
...
const { apprenticeassassin } = require("./apprenticeassassin")
...
const { bodysnatcher } = require("./bodysnatcher")
const { supervillains } = require("./supervillains")
const { temptress } = require("./temtress")
