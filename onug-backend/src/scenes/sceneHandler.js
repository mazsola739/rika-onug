...
export const sceneHandler = async (gamestate, scene_title) => {
  ...
  const roleHandlers = {
    ...
    BEHOLDER: (gamestate, title, selected_cards) =>
      beholder(gamestate, title, hasSeer(selected_cards), hasApprenticeSeer(selected_cards), hasDoppelganger(selected_cards)),
    ...
    DOPPELGÄNGER: (gamestate, title) => doppelganger(gamestate, title),
    DOPPELGÄNGER_APPRENTICE_ASSASSIN: (gamestate, title, selected_cards) => apprenticeassassin(gamestate, title, hasAssassin(selected_cards), 'doppelganger_apprenticeassassin'),
    DOPPELGÄNGER_ASSASSIN: (gamestate, title) => assassin(gamestate, title, 'doppelganger_assassin'),
    DOPPELGÄNGER_BODY_SNATCHER: (gamestate, title) => bodysnatcher(gamestate, title, 'doppelganger_bodysnatcher'),
    DOPPELGÄNGER_CURATOR: (gamestate, title) => curator(gamestate, title, 'doppelganger_curator'),
    DOPPELGÄNGER_EMPATH: (gamestate, title) => empath(gamestate, title, 'doppelganger_empath'),
    DOPPELGÄNGER_EXPOSER: (gamestate, title) => exposer(gamestate, title, 'doppelganger_exposer'),
    DOPPELGÄNGER_FLIPPER: (gamestate, title) => flipper(gamestate, title, 'doppelganger_flipper'),
    DOPPELGÄNGER_GREMLIN: (gamestate, title) => gremlin(gamestate, title, 'doppelganger_gremlin'),
    DOPPELGÄNGER_INSTANT_ACTION: (gamestate, title) => doppelgangerinstantaction(gamestate, title),
    DOPPELGÄNGER_MORTICIAN: (gamestate, title) => mortician(gamestate, title, 'doppelganger_mortician'),
    DOPPELGÄNGER_PICKPOCKET: (gamestate, title) => pickpocket(gamestate, title, 'doppelganger_pickpocket'),
    DOPPELGÄNGER_PRIEST: (gamestate, title) => priest(gamestate, title, 'doppelganger_priest'),
    DOPPELGÄNGER_PSYCHIC: (gamestate, title) => psychic(gamestate, title, 'doppelganger_psychic'),
    DOPPELGÄNGER_RASCAL: (gamestate, title) => rascal(gamestate, title, 'doppelganger_rascal'),
    DOPPELGÄNGER_REVEALER: (gamestate, title) => revealer(gamestate, title, 'doppelganger_revealer'),
    DOPPELGÄNGER_THE_COUNT: (gamestate, title) => thecount(gamestate, title, 'doppelganger_thecount'),
    ...
    EPIC_BATTLE: (gamestate, title, selected_cards) =>
      epicbattle(
        gamestate,
        title,
        hasEasterEgg(selected_cards, total_players),
        hasEpicBattle(selected_cards),
        total_players,
