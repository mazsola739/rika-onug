...
export const doppelgangerResponse = (
  gamestate,
  token,
  ...
  newGamestate.players[token].card.player_role_id =
    newGamestate.card_positions[selected_card_positions[0]].card.id
  ...
  ;(newGamestate.players[token].player_history[title].show_cards = showCards),
  ...
  const private_message = [
    ...
    `role_${newGamestate.players[token]?.card.player_role.toLowerCase()}`,
  ]
