...
export const drpeeker = (gameState, title) => {
  ...
  tokens.forEach((token) => {
    ...
    if (newGameState.players[token].card.player_original_id === 57 || (newGameState.players[token].card.player_role_id === 57 && newGameState.players[token].card.player_original_id === 30) || (newGameState.players[token].card.player_role_id === 57 && newGameState.players[token].card.player_original_id === 64)) {
