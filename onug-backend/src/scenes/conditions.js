import { ALL_VAMPIRE_IDS, ALL_ALIEN_IDS, GROOB_AND_ZERB_IDS, ALL_SUPER_VILLAIN_IDS, WEREVOLVES, MASONS, GOOD_GUY_IDS, BAD_GUY_IDS, DOPPELGANGER_INSTANT_ACTION_IDS, SEERS, HAS_MARK_IDS, ALL_WEREWOLF_IDS } from '../constants'

export const hasEpicBattle = (selected_cards) => {
  const battles = {
    vampire: ALL_VAMPIRE_IDS.some(id => selected_cards.includes(id)),
    alien: ALL_ALIEN_IDS.some(id => selected_cards.includes(id)),
    werewolf: ALL_WEREWOLF_IDS.some(id => selected_cards.includes(id)),
    villain: ALL_SUPER_VILLAIN_IDS.some(id => selected_cards.includes(id))
  }
...
export const hasGoodGuys = (selected_cards) => GOOD_GUY_IDS.some((id) => selected_cards.includes(id))
export const hasBadGuys = (selected_cards) => BAD_GUY_IDS.some((id) => selected_cards.includes(id))
...
export const hasInstantAction = (selected_cards) => DOPPELGANGER_INSTANT_ACTION_IDS.some((id) => selected_cards.includes(id))
export const hasAnyVampire = (selected_cards) => ALL_VAMPIRE_IDS.some((id) => selected_cards.includes(id))
...
export const hasAnyAlien = (selected_cards) => ALL_ALIEN_IDS.some((id) => selected_cards.includes(id))
export const hasCow = (selected_cards) => selected_cards.includes(45)
export const hasGroobAndZerb = (selected_cards) => GROOB_AND_ZERB_IDS.every((cardId) => selected_cards.includes(cardId))
...
export const hasAnySuperVillains = (selected_cards) => ALL_SUPER_VILLAIN_IDS.some((id) => selected_cards.includes(id))
...
export const hasAnyWerewolf = (selected_cards) => WEREVOLVES.some((id) => selected_cards.includes(id))
...
export const hasMarks = (selected_cards) => HAS_MARK_IDS.some((id) => selected_cards.includes(id))
...
export const hasRipple = (selected_cards) => ALL_ALIEN_IDS.some((id) => selected_cards.includes(id)) //TODO oracle is enough for ripple
