...
export const hasGoodGuys = selected_cards => GOOD_GUY.some(id => selected_cards.includes(id))
export const hasBadGuys = selected_cards => BAD_GUY.some(id => selected_cards.includes(id))
...
export const hasAnyVampire = selected_cards => VAMPIRE_IDS.some(id => selected_cards.includes(id))
...
export const hasAnyAlien = selected_cards => ALIEN_IDS.some(id => selected_cards.includes(id))
...
export const hasTemptress = selected_cards => selected_cards.includes(69) //TODO do I need
...
export const hasAlphaWolf = selected_cards => selected_cards.includes(17) //TODO do I need
...
export const hasAnyMason = selected_cards => MASONS.some(id => selected_cards.includes(id))
...
export const hasMarks = selected_cards => HAS_MARK.some(id => selected_cards.includes(id))
...
export const hasSeers = selected_cards => SEERS.some(id => selected_cards.includes(id))
...
export const hasRipple = selected_cards => ALIEN_IDS.some(id => selected_cards.includes(id))
