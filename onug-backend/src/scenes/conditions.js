...
export const hasGoodGuys = (selected_cards) =>
  GOOD_GUY.some((id) => selected_cards.includes(id))
export const hasBadGuys = (selected_cards) =>
  BAD_GUY.some((id) => selected_cards.includes(id))
...
export const hasInstantAction = (selected_cards) =>
  DOPPELGANGER_INSTANT_ACTION.some((id) => selected_cards.includes(id))
export const hasAnyVampire = (selected_cards) =>
  ALL_VAMPIRE.some((id) => selected_cards.includes(id))
...
export const hasApprenticeAssassin = (selected_cards) =>
  selected_cards.includes(28)
export const hasSentinel = (selected_cards) => selected_cards.includes(25)
export const hasAnyAlien = (selected_cards) =>
  ALL_ALIEN.some((id) => selected_cards.includes(id))
export const hasCow = (selected_cards) => selected_cards.includes(45)
export const hasGroobAndZerb = (selected_cards) =>
  GROOB_AND_ZERB.every((cardId) => selected_cards.includes(cardId))
...
export const hasAnySuperVillains = (selected_cards) =>
  ALL_SUPER_VILLAIN.some((id) => selected_cards.includes(id))
...
export const hasAnyWerewolf = (selected_cards) =>
  ALL_WEREWOLF.some((id) => selected_cards.includes(id))
...
export const hasApprenticeTanner = (selected_cards) =>
  selected_cards.includes(71)
...
export const hasBothMasons = (selected_cards) =>
  MASONS.every((cardId) => selected_cards.includes(cardId))
export const hasAnyMason = (selected_cards) =>
  MASONS.some((id) => selected_cards.includes(id))
...
export const hasParanormalInvestigator = (selected_cards) =>
  selected_cards.includes(23)
...
export const hasMarks = (selected_cards) =>
  HAS_MARK.some((id) => selected_cards.includes(id))
...
export const hasSelfAwarenessGirl = (selected_cards) =>
  selected_cards.includes(67)
export const hasSquire = (selected_cards) => selected_cards.includes(83)
export const hasSeers = (selected_cards) =>
  SEERS.some((id) => selected_cards.includes(id))
...
export const hasRipple = (selected_cards) =>
  ALL_ALIEN.some((id) => selected_cards.includes(id)) //TODO oracle is enough for ripple

export const hasEasterEgg = (selected_cards, totalPlayers) =>
  !hasGoodGuys(selected_cards) ||
  !hasBadGuys(selected_cards) ||
  totalPlayers === 12
export const haOneMasonAndDoppelganger = (selected_cards) =>
  hasDoppelganger(selected_cards) && hasAnyMason(selected_cards)
export const hasMasons = (selected_cards) =>
  hasBothMasons(selected_cards) || haOneMasonAndDoppelganger(selected_cards)
export const hasBeholder = (selected_cards) =>
  selected_cards.includes(73) && hasSeers
