...
export const hasGoodGuys = (selected_cards) => goodGuyIds.some((id) => selected_cards.includes(id))
export const hasBadGuys = (selected_cards) => badGuysIds.some((id) => selected_cards.includes(id))
...
export const hasInstantAction = (selected_cards) => doppelgangerInstantActionsIds.some((id) => selected_cards.includes(id))
export const hasAnyVampire = (selected_cards) => vampireIds.some((id) => selected_cards.includes(id))
...
export const hasAnyWerewolf = (selected_cards) => werewolvesIds.some((id) => selected_cards.includes(id))
...
export const hasBothMasons = (selected_cards) => masonIds.every((cardId) => selected_cards.includes(cardId))
export const hasAnyMason = (selected_cards) => masonIds.some((id) => selected_cards.includes(id))
...
export const hasMarks = (selected_cards) => hasMarkIds.some((id) => selected_cards.includes(id))
...
export const hasSeers = (selected_cards) => seerIds.some((id) => selected_cards.includes(id))
