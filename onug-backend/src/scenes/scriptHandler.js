  ...
  const roleOrder = [
    ...
    },
    {
      condition: () =>
        ...
        conditions.hasInstantAction(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasTheCount(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasPriest(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasApprenticeAssassin(selected_cards),
    ...
    {
      condition: () =>
        conditions.hasAnyVampire(selected_cards) && newGamestate.alien.vote,
      scripts: ['ALIENS_VOTE'],
    },
    ...
    {
      condition: () =>
        conditions.hasLeader(selected_cards) &&
        conditions.hasAnyAlien(selected_cards),
      scripts: ['LEADER'],
    },
    {
      condition: () =>
        conditions.hasLeader(selected_cards) &&
        conditions.hasGroobAndZerb(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasBodySnatcher(selected_cards),
    ...
    {
      condition: () =>
        conditions.hasApprenticeTanner(selected_cards) &&
        conditions.hasTanner(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasPsychic(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasPickpocket(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasGremlin(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasRascal(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasRevealer(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasExposer(selected_cards),
    ...
    },
    {
      condition: () =>
        conditions.hasDoppelganger(selected_cards) &&
        conditions.hasMortician(selected_cards),
