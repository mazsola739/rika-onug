...
exports.interactionHandler = (gameState) => {
  ...
  switch (sceneTitle) {
    ...
    case "ORACLE_REACTION": // (Scene Number: 3) //TODO make sure always have answer if oracle in selected cards
      if (conditions.hasOracle && oracleAnswer) return roles.oracle_reaction(gameState)
      break
    ...
    case "DOPPELGÄNGER_THE_COUNT": // (Scene Number: 10)
      if (conditions.hasDoppelganger && conditions.hasTheCount) return roles.doppelganger_thecount(gameState)
      break

    case "RENFIELD": // (Scene Number: 11)
      if (conditions.hasRenfield) return roles.renfield(gameState)
      break
    ...
    case "DOPPELGÄNGER_PRIEST": // (Scene Number: 16)
      if (conditions.hasDoppelganger && conditions.hasPriest) return roles.doppelganger_priest(gameState)
      break
    ...
    case "DOPPELGÄNGER_ASSASSIN": // (Scene Number: 18)
      if (conditions.hasDoppelganger && conditions.hasAssassin) return roles.doppelganger_assassin(gameState)
      break

    case "APPRENTICE_ASSASSIN": // (Scene Number: 19)
      if (conditions.hasApprenticeAssassin) return roles.apprenticeassassin(gameState)
      break

    case "DOPPELGÄNGER_APPRENTICE_ASSASSIN": // (Scene Number: 20)
      if (conditions.hasDoppelganger && conditions.hasApprenticeAssassin) return roles.doppelganger_apprenticeassassin(gameState)
      break
    ...
    case "GROOB_ZERB": // (Scene Number: 26)
      if (conditions.hasGroobAndZerb) return roles.groobzerb(gameState)
      break

    case "LEADER": // (Scene Number: 27)
      if (conditions.hasLeader && conditions.hasAnyAlien) return roles.leader(gameState)
      break

    case "LEADER_ZERB_GROOB": // (Scene Number: 28)
      if (conditions.hasLeader && conditions.hasGroobAndZerb) return roles.leader_zerbgroob(gameState)
      break
    ...
    case "DOPPELGÄNGER_BODY_SNATCHER": // (Scene Number: 30)
      if (conditions.hasDoppelganger && conditions.hasBodySnatcher) return roles.doppelganger_bodysnatcher(gameState)
      break
    ...
    case "EVILOMETER": // (Scene Number: 35)
      if (conditions.hasEvilometer) return roles.evilometer(gameState)
      break

    case "WEREWOLVES": // (Scene Number: 36)
      if (conditions.hasAnyWerewolf) return roles.werewolves(gameState)
      break
    ...
    case "PARANORMAL_INVESTIGATOR": // (Scene Number: 48)
      if (conditions.hasParanormalInvestigator) return roles.paranormalinvestigator(gameState)
      break

    case "MARKSMAN": // (Scene Number: 49)
      if (conditions.hasMarksman) return roles.marksman(gameState)
      break
    ...
    case "NOSTRADAMUS_REACTION": // (Scene Number: 51)
      if (conditions.hasNostradamus) return roles.nostradamus_reaction(gameState)
      break
    ...
    case "DOPPELGÄNGER_PSYCHIC": // (Scene Number: 53)
      if (conditions.hasDoppelganger && conditions.hasPsychic) return roles.doppelganger_psychic(gameState)
      break
    ...
    case "DOPPELGÄNGER_PICKPOCKET": // (Scene Number: 58)
      if (conditions.hasDoppelganger && conditions.hasPickpocket) return roles.doppelganger_pickpocket(gameState)
      break
    ...
    case "AURA_SEER": // (Scene Number: 63)
      if (conditions.hasAuraSeer) return roles.auraseer(gameState)
      break
    ...
    case "DOPPELGÄNGER_GREMLIN": // (Scene Number: 65)
      if (conditions.hasDoppelganger && conditions.hasGremlin) return roles.doppelganger_gremlin(gameState)
      break
    ...
    case "DOPPELGÄNGER_RASCAL": // (Scene Number: 67)
      if (conditions.hasDoppelganger && conditions.hasRascal) return roles.doppelganger_rascal(gameState)
      break
    ...
    case "BEHOLDER": // (Scene Number: 73)
      if (conditions.hasBeholder) return roles.beholder(gameState)
      break
    ...
    case "DOPPELGÄNGER_REVEALER": // (Scene Number: 75) //! FLIPPED
      if (conditions.hasDoppelganger && conditions.hasRevealer) return roles.doppelganger_revealer(gameState)
      break
    ...
    case "DOPPELGÄNGER_EXPOSER": // (Scene Number: 77) //! FLIPPED
      if (conditions.hasDoppelganger && conditions.hasExposer) return roles.doppelganger_exposer(gameState)
      break
    ...
    case "DOPPELGÄNGER_FLIPPER": // (Scene Number: 79)
      if (conditions.hasDoppelganger && conditions.hasFlipper) return roles.doppelganger_flipper(gameState)
      break
    ...
    case "DOPPELGÄNGER_EMPATH": // (Scene Number: 81)
      if (conditions.hasDoppelganger && conditions.hasEmpath) return roles.doppelganger_empath(gameState)
      break
    ...
    case "DOPPELGÄNGER_CURATOR": // (Scene Number: 83) //! ARTIFACT visibility
      if (conditions.hasDoppelganger && conditions.hasCurator) return roles.doppelganger_curator(gameState)
      break
    ...
    case "DOPPELGÄNGER_MORTICIAN": // (Scene Number: 86)
      if (conditions.hasMortician && conditions.hasDoppelganger) return roles.doppelganger_mortician(gameState)
      break
