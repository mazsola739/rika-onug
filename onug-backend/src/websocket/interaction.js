...
const generateInteractionResponse = (gameState, token, selected_positions, ws) => {
  ...
  //if (interaction_type === "DETECTOR")                   return roles.detector_response(newGameState, token, selected_positions, interaction_type)
  ...
  //if (interaction_type === "VOODOO_LOU")                  return roles.voodoolou_response(newGameState, token, selected_positions, interaction_type)
