...
const createGameStateCardForm = (card, selected_cards) => {
...
exports.dealCards = async (ws, message) => {
  ...
  const { playerCards, centerCards, newWolfCard, newVillainCard } = dealCardIds(selectedCards)
  ...
  const newGameState = {
    ...
    center_cards: {
      center_left_card:    createGameStateCardForm(leftCard,       selectedCards),
      center_middle_car:   createGameStateCardForm(middleCard,     selectedCards),
      center_right_card:   createGameStateCardForm(rightCard,      selectedCards),
      center_wolf_card:    createGameStateCardForm(newWolfCard,    selectedCards),
      center_villain_card: createGameStateCardForm(newVillainCard, selectedCards),
    },
  }
