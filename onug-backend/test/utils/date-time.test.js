...
const { isTimeElapsed } = require("../../src/utils/date-time")
...
describe("Test date-time utils", () => {
    it("should correctly measure elapsed time-periods", () => {
        ...
        testData.forEach( data => {
            ...
            console.log(`testing: fromTimeStamp[${fromTimeStamp}] now[${Date.now()}] durationSecond[${durationSecond}] should be ${expected ? 'elapsed' : 'not elapsed'}`)
