...
const isLogLevelEnabled = logLevel => {
  switch (logLevel) {
    ...
    case LOG_LEVELS.WARN:
      return LOG_LEVEL === LOG_LEVELS.WARN || LOG_LEVEL === LOG_LEVELS.INFO || LOG_LEVEL === LOG_LEVELS.DEBUG || LOG_LEVEL === LOG_LEVELS.TRACE
    case LOG_LEVELS.INFO:
      return LOG_LEVEL === LOG_LEVELS.INFO || LOG_LEVEL === LOG_LEVELS.DEBUG || LOG_LEVEL === LOG_LEVELS.TRACE
